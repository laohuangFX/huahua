...
- (void)setCell {
    ...
    self.praiseImageView = [[UIImageView alloc] initWithFrame:CGRectMake(hua_scale(114), self.goodsNameLabel.x + self.goodsNameLabel.height + hua_scale(6), hua_scale(hua_scale(9)), hua_scale(8))];
    self.praiseImageView.image = [UIImage imageNamed:@"productprise"];
    [self addSubview:self.praiseImageView];
    
    
    CGRect praiseFrame = CGRectMake(hua_scale(125), self.goodsNameLabel.x + self.goodsNameLabel.height + hua_scale(6), hua_scale(100), hua_scale(8));
    ...
    CGRect priceFrame = CGRectMake(hua_scale(114), hua_scale(77), hua_scale(150), hua_scale(10));
