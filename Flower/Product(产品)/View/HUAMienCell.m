...
- (void)setDetailInfo:(HUAMasterDetailInfo *)detailInfo {
    ...
    [self.mienImageView sd_setImageWithURL:[NSURL URLWithString:detailInfo.url] placeholderImage:[UIImage imageNamed:@"placeholder"]];
}
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.mienImageView.backgroundColor = [UIColor redColor];
    }
    return self;
}
